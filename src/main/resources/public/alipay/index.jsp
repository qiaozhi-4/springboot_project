...
<header class="am-header">
    <h1>支付宝电脑网站支付体验入口页<br/><span class="em">（改成自己的）</span></h1>
</header>
<div id="main">
    ...
    <form name="alipayment" action="alipay.trade.page.pay.jsp" method="post"
        ...
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                <dt>商户订单号<span class="em">（你自己的订单ID）</span></dt>
                <dd>
                    <input id="WIDout_trade_no" name="WIDout_trade_no"/>
                </dd>
                <hr class="one_line">
                <dt>订单名称<span class="em">（你自己的订单名）</span></dt>
                <dd>
                    <input id="WIDsubject" name="WIDsubject"/>
                </dd>
                <hr class="one_line">
                <dt>付款金额<span class="em">（客户订单金额）</span></dt>
                <dd>
                    <input id="WIDtotal_amount" name="WIDtotal_amount"/>
                </dd>
                <hr class="one_line">
                <dt>商品描述<span class="em">（订单说明）</span></dt>
                <dd>
                ...
                <dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
                                    style="text-align: center;">付款<span class="em">（提交到的JSP为：alipay.trade.page.pay.jsp）</span></button>
